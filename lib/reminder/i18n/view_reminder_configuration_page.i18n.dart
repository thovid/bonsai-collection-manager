...
extension Localization on String {
  static var _t = (Translations("en_us") +
          {"en_us": "Reminder", "de": "Erinnerung"} +
          {"en_us": "Cancel", "de": "Abbrechen"} +
          {"en_us": "Edit reminder", "de": "Erinnerung bearbeiten"} +
          {"en_us": "Create reminder", "de": "Erinnerung anlegen"} +
          ...
          {"en_us": "For", "de": "Für"} +
          {"en_us": "Starts", "de": "Beginnt"} +
          {"en_us": "Repeats", "de": "Wiederholt"} +
          {"en_us": "Ends", "de": "Endet"} +
          {"en_us": "Once", "de": "Einmal"} +
          {"en_us": "Every %d %s", "de": "Alle %d %s"} +
          {"en_us": "Never", "de": "Nie"} +
          {
          ...
          {"en_us": "At %s", "de": "Am %s"} +
          {"en_us": "Reminder deleted", "de": "Erinnerung gelöscht"} +
          {"en_us": "Reminder created", "de": "Erinnerung angelegt"} +
          {"en_us": "Reminder saved", "de": "Erinnerung gespeichert"}) *
